    ...
    <div>
      <div className="description_individual_product">
        ...
        <div className="description-final">
          ...
          efficitur metus. Donec vestibulum tortor nec nibh dapibus, et
          elementum urna commodo.
          <br />
          <br />
          Curabitur fermentum risus ut sollicitudin suscipit. Phasellus
          tristique, elit non eleifend viverra, sapien risus laoreet leo, non
          fringilla sem metus a odio. Quisque laoreet augue ac turpis tempus
          mollis. Suspendisse potenti. In hac habitasse platea dictumst. Nulla
          facilisi. Sed at nisi et lorem eleifend finibus.
        </div>
      </div>
    </div>
  );
